...
def create_account_helper_funtion (userName,hashedPassword,salt):
    try:
         #make sure username is not already taken
         dataBase="some database object"
         if(dataBase.findOne(userName)):
         ...
         #connection to database here storing userName and password and salt
         else:
